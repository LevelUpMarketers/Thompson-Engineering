...
if ( ! class_exists( 'TEQcidbPlugin_Settings_Settings2_Tab', false ) ) :
	...
	class TEQcidbPlugin_Settings_Settings2_Tab {
		...
		public function __construct() {
			...
			require_once TEQCIDB_CLASS_DIR . 'class-classes-three-form.php';

			// Instantiate the class.
			$this->template = new TEQcidbPlugin_Admin_UI_Template();
			$this->form     = new TEQcidbPlugin_settings3_Form();
		...
		private function output_open_admin_container() {
			$title    = 'Various Class Forms';
			$icon_url = TEQCIDB_ROOT_IMG_URL . 'employee.png';
