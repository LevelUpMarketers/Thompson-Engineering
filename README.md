...
- Added a **Student Refresher Class Completed** editor to **Communications → Email Templates** for configuring the future logged-in-student notification when Refresher slides are completed; automatic delivery is not wired yet.
