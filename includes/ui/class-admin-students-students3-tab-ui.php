<?php
/**
 * TEQcidbPlugin_Settings_Settings3_Tab Tab - class-admin-settings-libraries-tab-ui.php.
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'TEQcidbPlugin_Settings_Settings3_Tab', false ) ) :

	/**
	 * TEQcidbPlugin_Settings_Settings3_Tab Class.
	 */
	class TEQcidbPlugin_Settings_Settings3_Tab {
		...
		public function __construct() {
			...
			require_once TEQCIDB_CLASS_DIR . 'class-students-three-form.php';

			// Instantiate the class.
			$this->template = new TEQcidbPlugin_Admin_UI_Template();
			$this->form     = new TEQcidbPlugin_settings2_Form();
		...
		private function output_open_admin_container() {
			$title    = 'Student Forms';
			$icon_url = TEQCIDB_ROOT_IMG_URL . 'clipboard.png';
...
// Instantiate the class.
$cm = new TEQcidbPlugin_Settings_Settings3_Tab();
