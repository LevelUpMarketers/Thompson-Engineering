...
91. 2025-11-12: Replaced the student schema with the finalized column list from the client spec (password, guardian, representative, contact, and tracking fields) and aligned the helper preview query with the schema primary key.
