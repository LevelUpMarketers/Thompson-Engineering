...
class TEQCIDB_Shortcode_Student_Dashboard {
                                        ...
                                        <div class="teqcidb-dashboard-section teqcidb-dashboard-section--students">
                                            <div class="teqcidb-dashboard-section-header">
                                                ...
                                                <p class="teqcidb-dashboard-section-description">
                                                    <?php
                                                    echo esc_html_x(
                                                        'Below you can manage the students you\'re responsible for and edit their information.',
    ...
    private function get_dashboard_state_options() {
        return array(
            'Alabama',
            'Alaska',
            'Arizona',
            ...
            wp_localize_script(
                ...
                array(
                    ...
                    'studentSearch' => array(
                        ...
                        'editLabel' => esc_html_x( 'Edit This Student', 'Student dashboard student edit button label', 'teqcidb' ),
                        'editCancelLabel' => esc_html_x( 'Cancel Editing', 'Student dashboard student edit cancel label', 'teqcidb' ),
                        'saveLabel' => esc_html_x( 'Save Changes', 'Student dashboard student save button label', 'teqcidb' ),
                        'saveSuccess' => esc_html_x( 'Student details updated.', 'Student dashboard student save success message', 'teqcidb' ),
                        'saveError' => esc_html_x( 'Unable to save student details right now. Please try again.', 'Student dashboard student save error message', 'teqcidb' ),
                        ...
                        'assignedWalletActionsLabel' => esc_attr_x( 'Wallet card actions', 'Student dashboard assigned student wallet card actions label', 'teqcidb' ),
                        'assignedWalletPrintLabel' => esc_html_x( 'Print Wallet Card', 'Student dashboard assigned student wallet card print button label', 'teqcidb' ),
                        'assignedWalletDownloadLabel' => esc_html_x( 'Download Wallet Card', 'Student dashboard assigned student wallet card download button label', 'teqcidb' ),
                        'assignedInitialActionsLabel' => esc_attr_x( 'Initial certificate actions', 'Student dashboard assigned student initial certificate actions label', 'teqcidb' ),
                        'assignedInitialPrintLabel' => esc_html_x( 'Print Initial Certificate', 'Student dashboard assigned student initial certificate print button label', 'teqcidb' ),
                        'assignedInitialDownloadLabel' => esc_html_x( 'Download Initial Certificate', 'Student dashboard assigned student initial certificate download button label', 'teqcidb' ),
                        'assignedRefresherActionsLabel' => esc_attr_x( 'Refresher certificate actions', 'Student dashboard assigned student refresher certificate actions label', 'teqcidb' ),
                        'assignedRefresherPrintLabel' => esc_html_x( 'Print Refresher Certificate', 'Student dashboard assigned student refresher certificate print button label', 'teqcidb' ),
                        'assignedRefresherDownloadLabel' => esc_html_x( 'Download Refresher Certificate', 'Student dashboard assigned student refresher certificate download button label', 'teqcidb' ),
                        'booleanLabels' => array(
    ...
    private function decode_student_address_field( $value ) {
        ...
        $defaults['state'] = $this->normalize_dashboard_state_value( $defaults['state'] );

        return $defaults;
    }

    private function normalize_dashboard_state_value( $value ) {
        ...
        foreach ( $states as $state ) {
            if ( 0 === strcasecmp( $normalized, $state ) ) {
                return $state;
            }
        }
        ...
        $upper_code = strtoupper( $normalized );

        if ( isset( $state_codes[ $upper_code ] ) ) {
            return $state_codes[ $upper_code ];
        }
