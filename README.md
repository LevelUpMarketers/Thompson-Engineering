...
- Manage quiz records under **Quizzes**, switching between **Create a Quiz** and **Edit Quizzes** tabs. The create form now focuses on a quiz name plus class-association checkboxes, storing selected class IDs as a comma-separated value in `teqcidb_quizzes.class_id` (for example: `41,32,1,19`).
