...
if ( ! class_exists( 'TEQcidbPlugin_settings1_Form', false ) ) :
	...
	class TEQcidbPlugin_settings1_Form {
...

		{
			...
			$this->studentsdbresults = $wpdb->get_results( "SELECT * FROM $this->students_table WHERE newregistrantflag = 'true' ORDER BY lastname ASC, firstname ASC" );
...
*/
			...
			$string1 = '<div class="teqcidb-display-search-ui-top-container">
							...
							<p class="teqcidb-tab-intro-para teqcidb-tab-intro-para-searchsort">Below are all of your new students! Expand each student and click the "Mark Student as Viewed" button to make them magically disappear from this list.</p>
								...
								<div class="teqcidbplugin-form-section-wrapper" id="teqcidbplugin-form-section-wrapper-' . $value->ID . '">
									...
									<div class="teqcidbplugin-form-section-fields-wrapper">
										...
										<div class="teqcidbplugin-form-section-fields-indiv-wrapper">
											...
											<button  data-id="' . $value->ID . '" data-wpuserid="' . $value->wpuserid . '" data-uniquestudentid="' . $value->uniquestudentid . '" class="teqcidbplugin-form-section-submit-button teqcidbplugin-form-section-mark-student-viewed-submit-button">Mark Student as Viewed</button>
