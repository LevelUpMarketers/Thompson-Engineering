...
- Enable PHP error logging from **TEQCIDB Settings → General Settings** only after testing; logging is disabled by default while we troubleshoot the memory exhaustion reported during activation.
