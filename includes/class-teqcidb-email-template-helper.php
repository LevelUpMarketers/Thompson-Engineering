...
class TEQCIDB_Email_Template_Helper {
    ...
    public static function get_option_name() {
         ...
         */
        return apply_filters( 'teqcidb_email_templates_option_name', 'teqcidb_email_templates' );
    }
    ...
    public static function sanitize_from_name( $value ) {
         ...
         */
        return apply_filters( 'teqcidb_email_template_from_name', $value );
    }
    ...
    public static function sanitize_from_email( $value ) {
         ...
         * @param string $value Sanitized value.
         */
        return apply_filters( 'teqcidb_email_template_from_email', $value );
    }
    ...
    public static function get_default_from_name() {
         ...
         */
        return apply_filters( 'teqcidb_default_from_name', $site_name );
    }
    ...
    public static function get_default_from_email() {
         ...
         */
        return apply_filters( 'teqcidb_default_from_email', $email );
    }
    ...
    public static function get_template_label( $template_id ) {
        ...
        $label = apply_filters( 'teqcidb_email_template_label', '', $template_id );

        if ( '' === $label ) {
            $label = preg_replace( '/^teqcidb[-_]/', '', $template_id );
