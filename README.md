...
- Manage classes under **Classes**, including storing each session's **Teams Link**, a dedicated **Class URL** value for future virtual page routing, and **Class Resources** rows (name, type, and URL) that are saved as structured JSON per class.
