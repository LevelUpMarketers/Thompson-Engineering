<?php
/**
 * TEQcidbPlugin_Settings_Settings2_Tab Tab - class-admin-settings-libraries-tab-ui.php.
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'TEQcidbPlugin_Settings_Settings2_Tab', false ) ) :

	/**
	 * TEQcidbPlugin_Settings_Settings2_Tab Class.
	 */
	class TEQcidbPlugin_Settings_Settings2_Tab {
		...
		public function __construct() {
			...
			require_once TEQCIDB_CLASS_DIR . 'class-students-two-form.php';
		...
		private function output_open_admin_container() {
			$title    = 'Edit Students';
			$icon_url = TEQCIDB_ROOT_IMG_URL . 'reading.png';
...
// Instantiate the class.
$cm = new TEQcidbPlugin_Settings_Settings2_Tab();
